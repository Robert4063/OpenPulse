...
## 项目分工
- **杨家辉** — React/Vue前端框架的构建，GitHub开源数据爬取与清洗，后端技术栈、数据库的构建，前后端响应系统构建，四维评估体系与PHAM v2.0模型的构建，描绘贡献者的画像。
- **庞毅飞** — MaxKB智能体的本地部署、网络连接与（知识库、模型）构建，GitHub开源数据爬取与清洗，后端数据库的构建，PHAM v2.0模型构建的可行性分析，市场需求调研与相关数据分析，PPT制作与报告撰写。
## 核心功能
