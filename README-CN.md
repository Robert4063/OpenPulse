...
**核心能力：**
- **社区全景** — 多维健康度量，3D可视化协作关系
- **生命周期** — 历史回溯 + 趋势预测，结合 OpenDigger 数据
- **智能协作** — MaxKB 智能体协助数据分析
- **智能搜索** — 热度榜单、智能排序、贡献者画像

## 项目分工
- **杨家辉** — React/Vue前端框架的构建，GitHub开源数据爬取，后端技术栈的、数据库的构建，前后端响应系统构建，四维评估体系构建与PHAM v2.0模型建模分析。
- **庞毅飞** — MaxKB智能体的部署、网络连接与构建，GitHub开源数据爬取与清洗，后端数据库的构建，市场需求调研与相关数据分析，PPT制作与报告撰写。
## 核心功能
