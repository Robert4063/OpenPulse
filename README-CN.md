...
## 项目简介
**OpenPulse** 是一个全方位的开源社区健康评估平台，通过多维度可视化与智能分析，深度挖掘社区的脉搏与生命力。系统集成 OpenDigger 数据，并利用 AI 驱动的智能体协作进行实时分析。

**核心能力：**
- **社区全景** — 多维健康度量，呈现健康报告
- **生命周期** — 历史回溯 + 趋势预测，结合 OpenDigger 数据
- **智能协作** — MaxKB 智能体协助数据分析
...
![项目演示](./images/search.png)
### 项目大屏
- **总览图** — 观察紧密度折线图、活跃度直方图
- **健康度分析** — 查看这个项目在PHAM模型下面计算得出来的健康程度
![项目演示](./images/health.png)
### 关系网络交互
- **查看健康度相似的项目** — 在列表中查看健康度相似的项目
...
## 项目后台报错
后端数据无法传输到前端的时候，会在前端弹出一个提示，开发人员可通过这个提示进行后端的改进
![项目演示](./images/error.png)
...
## 项目分工
- 组长： **[@Robert4063 杨家辉](httpS://github.com/Robert4063)** — React前端框架的构建，GitHub中issue,comments开源数据爬取与清洗和维度导入，OpenDigger数据爬取，后端技术栈、后端数据库的连接和架构，前后端响应系统构建，构想四维评估体系，构建计算PHAM v2.0模型，贡献者分析维度决策。
- 成员： **[@pyf060502-glitch 庞毅飞](https://github.com/pyf060502-glitch)** — MaxKB智能体的本地部署、网络连接与（知识库、模型）构建，GitHub中star,fork开源数据爬取与清洗、整理，PHAM v2.0模型构建的可行性分析，市场需求调研与相关数据分析，PPT制作与报告撰写。
